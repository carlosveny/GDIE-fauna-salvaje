...
function updateQuality(newQuality) {
    ...
    if (newQuality === 0) {
        ...
        span.innerHTML = `AUTO (${window.hls.levels[window.hls.currentLevel].height}p)`
        span2.innerHTML = `Quality<span class="plyr__menu__value">AUTO (${window.hls.levels[window.hls.currentLevel].height}p)</span>`
    } else {
